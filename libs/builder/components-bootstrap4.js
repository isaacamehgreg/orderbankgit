...
Vvveb.Components.extend("_base", "html/div", {
    classes: ["div", "container", "container-fluid"],
    image: "icons/div.svg",
    html: '<div class="div" style="height:auto;">html div</div>',
    name: "Html Div",
    properties: [
     {
        name: "Type",
        ...
        htmlAttr: "class",
        inputtype: SelectInput,
        validValues: ["div", "container", "container-fluid"],
        data: {
            options: [{
                value: "div",
                text: "None"
...
Vvveb.Components.add("html/gridrow", {
    ...
    image: "icons/grid_row.svg",
    classes: ["row"],
    html: '<div class="row"><div class="col-sm-4"><h3>col-sm-4</h3></div><div class="col-sm-4 col-4"><h3>col-sm-4</h3></div><div class="col-sm-4"><h3>col-sm-4</h3></div></div>',
