                                    ...
                                    <table class="table table-striped table-bordered first" style="font-family: 'Proxima Nova Regular' !important">
                                        ...
                                        <thead>
                                            <tr>
                                               ...
                                               {{-- <th>Order No.</th>--}}
                                                <th><b style="color: #5E2CED;">FORM NAME</th>
                                                    <th><b style="color: #5E2CED;">FORM URL</th>
                                        ...
                                        <tbody>
                                              ...
                                              @php
                                                  ...
                                                  // customer
                                                  $profile = App\Business::where('user_id', $form->business_id)->first();
                                            ...
                                            <td>{{ $form->created_at }}</td>
                                               ...
                                               <td><a href="{{ url('form/'.$form->link) }}"><b style="color: #5E2CED;">{{ url('form/'.$form->link) }}</a></td>
                                                ...
                                                <td>
                                                  ...
                                                  <a href="{{ url('gadmin/forms/edit/'.$form->id) }}" class="btn btn-success">EDIT</a>

                                                  <a href="{{ url('gadmin/forms/delete/'.$form->id) }}" class="btn btn-danger delete" data-confirm="Are you sure to delete this form?">DELETE</a>
                                                  @if($form->is_hidden ?? TRUE)
                                                  <a href="{{ url('gadmin/forms/unhide/'.$form->id) }}" class="btn btn-secondary">UNHIDE</a>
                                                  @else
                                                  <a href="{{ url('gadmin/forms/hide/'.$form->id) }}" class="btn btn-secondary">HIDE</a>
                                                  @endif                                           
                                                  <a href="{{ url('gadmin/forms/delete/'.$form->id) }}" class="btn btn-primary">DISABLE</a>
