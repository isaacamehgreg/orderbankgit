@extends('gadmin')
@section('title', 'Edit Delivery Time')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit When You Want To Deliver Your Order <a href="/gadmin/delivery_time" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
...
<div class="row">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input name="time" value="{{ $deliverytime->value }}" class="form-control" />
                                    </div>
                                    </div>
                                    <br>
