...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Edit Your Form <a href="/contacts" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Manage forms</b></a></h5>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <select class="js-example-basic-multiple form-control" name="form_fields[]" multiple="multiple" style="padding: 10px !important;">
                                    ...
                                    <option @if(in_array('phone_number', $field)) selected @endif value="phone_number_one">Active Phone Number</option>
