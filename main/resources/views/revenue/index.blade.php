@extends('app')
@section('title', 'Sales Report (Revenue/Statistics)')
@section('content')
    <style>
        .chart_card {
            padding: 20px;
        ...
        <div class="offset-xl-7 col-xl-5 col-lg-3 col-md-6 col-sm-12 col-12">
            <form action="" method="get">
                <div class="input-group mb-3">
                  ...
                  <select name="filter" id="filter" style="height: 50px;" class="form-control">
                           ...
                           <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                    <a href="#!">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-inline-block">
                                                    <h5 class="text-muted">Ready For Delivery</h5>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <a href="#!">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-inline-block">
                                                    <h5 class="text-muted">Payment Received</h5>
...
$('#filter option').each(function() {
    if(document.getElementById('filter').value == "custom") {
     //Do something
     $('#custom').html('<input class="form-control" type="text" name="daterange" id="daterange" id="daterange" />');
    }
});
</script>
