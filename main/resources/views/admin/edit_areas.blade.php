@extends('app')
@section('title', 'Waybill - General - Areas - Edit')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit Area <a href="/general/recipients" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <label>Title</label>
                                        <input name="title" value="{{ $area->title }}" class="form-control" />
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <label>Shipping Fee</label>
                                        <input name="shipping_fee" value="{{ $area->shipping_fee }}" placeholder="2000" class="form-control" />
                                    </div>
               
                                    <div class="form-group col-md-6">
                                      <label for="inputEmail4">Select State</label>
                                        <select id="addrecipient_state" name="state_id" class="form-control">
                                            <option value="{{ $area->state_id }}" selected>Choose...</option>
