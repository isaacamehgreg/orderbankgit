@extends('app')
@section('title', 'Waybill - General - Couriers - Edit')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit Courier <a href="/general/recipients" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <label>Name</label>
                                        <input name="name" value="{{ $courier->name }}" class="form-control" />
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <label>Address</label>
                                        <input name="address" value="{{ $courier->address }}" class="form-control" />
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <label>Phone Number</label>
                                        <input name="phonenumber" value="{{ $courier->phonenumber }}" class="form-control" />
                                    </div>
