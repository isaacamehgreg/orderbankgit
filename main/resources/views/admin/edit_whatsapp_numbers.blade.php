@extends('app')
@section('title', 'Admin - WhatsApp Number - Edit')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">WhatsApp Number <a href="/admin/whatsapp_numbers" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input name="number" value="{{ $whatsapp_numbers->number }}" class="form-control" />
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <label>Device ID</label>
                                        <input name="device_id" value="{{ $whatsapp_numbers->device_id }}" class="form-control" />
                                    </div>
