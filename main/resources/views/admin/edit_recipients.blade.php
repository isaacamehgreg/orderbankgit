@extends('app')
@section('title', 'Waybill - General - Recipients - Edit')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit Recipient <a href="/general/recipients" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input value="{{ $recipient->firstname }}" name="firstname" class="form-control" />
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label>Lastname</label>
                                        <input value="{{ $recipient->lastname }}" name="lastname" class="form-control" />
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label>Phone Number</label>
                                        <input value="{{ $recipient->phonenumber }}" name="phonenumber" class="form-control" />
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        <label>Phone Number Two (optional)</label>
                                        <input value="{{ $recipient->phonenumber_two }}" name="phonenumber_two" class="form-control" />
                                    </div>

                                    <div class="col-sm-6 form-group">
                                        <label>Address (optional)</label>
                                        <input value="{{ $recipient->address }}" name="address" class="form-control" />
                                    </div>

                                    <div class="form-group col-md-6">
                                      <label for="inputEmail4">Select State</label>
                                        <select id="addrecipient_state" name="state_id" class="form-control">
                                            <option value="{{ $recipient->state_id }}" selected>Choose...</option>
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <select id="addrecipient_area" name="area_id" class="form-control">
                                        <option selected value="{{ $recipient->area_id }}">Choose...</option>
                                      </select>
                                    </div>
