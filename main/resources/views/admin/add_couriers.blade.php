@extends('app')
@section('title', 'Waybill - General - Couriers - Add')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Add Courier <a href="/general/recipients" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
