...
<head>
    <title>OrderBank | Reset Password</title>
    <meta charset="UTF-8">
...
<b style="font-size: 30px;">Welcome to OrderBank</b> <br>
    <b style="font-size: 15px;">Reset Your Password.</b>
</span>

                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" placeholder="New Password" type="password" name="password">
                        <span class="focus-input100"></span>
                    </div>


<div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100" placeholder="Confirm new password" type="password" name="password_confirmation">
                        <span class="focus-input100"></span>
                    </div>
