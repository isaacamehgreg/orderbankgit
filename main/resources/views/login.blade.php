...
<b style="font-size: 30px;">Welcome to OrderBank</b> <br>
    <b style="font-size: 15px;">Login With Your Correct Registered Details.</b>
</span>
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <br><br>
                        <a href="/forgot-password" class="login100-form-btn" style="background: #fff; color: #222;">
                            Forgot Password?
                        </a>
                        <hr><br>
                        <br><br>
                        <a href="/signup" class="login100-form-btn" style="background: #fff; color: #222;">
                            Register
                        </a>
                    </div>
