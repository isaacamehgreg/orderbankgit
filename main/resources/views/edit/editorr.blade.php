...
<html lang="en">
    <head>
        ...
        <title>Orderbank Salespage Builder</title>
        ...
        <link rel="stylesheet" type="text/css" href="plugins/css/examples.css" />
    ...
    <body>
        <div data-keditor="html">
            <div id="content-area">
                {!!htmlspecialchars_decode($editor->content)!!}
            </div>
        </div>
        ...
        <script type="text/javascript" src="plugins/js/examples.js"></script>
        <script type="text/javascript" data-keditor="script">
            $(function () {
                ...
                $(".fa-save").click(function(e){
                    e.preventDefault();
                    $.ajax({
                        url:"{{route('page.update', ['id' => $editor->id])}}",//set your server side save script url
                        type:"post",
                        headers: {
                        ...
                        success: function (response) {
                            alert('Successfully Saved this page');
                        },
