...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Create A Form To Sell Your Product<a href="/forms" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Manage forms</b></a></h5>
                            <div class="card-body">
                                   ...
                                   {{-- <div class="col-sm-12 form-group">
                                    ...
                                    <select class="js-example-basic-multiple form-control" name="products[]" multiple="multiple" style="padding: 10px !important;">
                                      @foreach(App\Products::where('business_id', auth()->id())->get() as $product)
                                        <option value="{{ $product->id }}">{{ $product->title }} - ({{ $product->qty }}) - N{{ $product->price }}</option>
                                      @endforeach
                                    </select>
                                </div>
                                ...
                                <select class="js-example-basic-multiple form-control" name="form_fields[]" multiple="multiple" style="padding: 10px !important;">							
                                    ...
                                    <option selected="" value="phone_number_one">Active Phone Number</option>
                                
                                                                  
                                    <option selected="" value="phone_number_two">Alternative Phone Number</option>
                                
                                                                  
                                    <option selected="" value="address">Full Address</option>
