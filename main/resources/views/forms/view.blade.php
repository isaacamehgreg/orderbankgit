                        ...
                        <div class="card" style="box-shadow: none;">
                            <div class="card-body" style="box-shadow: none;">
                                <form action="" method="post">
                                   ...
                                   <span><h1><center><b style="color: #8b0000;">Please Fill This Form Carefully To Place Your Order</center></h1></span>
<p><center><b style="color: #5E2CED;">Any Single Mistake Won't Allow us To Process Your order</center></p>
                                    ...
                                    @if(in_array('phone_number_one', $form_check))
                                    <div class="col-sm-12 form-group">
                                        <label>Your Active Phone Number (The delivery person will call you through this number to make delivery):</label>
                                        <input name="phonenumber" id="phonenumber" class="form-control" />
                                    </div>
                                    @endif

                                    @if(in_array('phone_number_two', $form_check))
                                    <div class="col-sm-12 form-group">
                                        <label>Alternative Phone Number (Optional):</label>
                                        <input name="phonenumbertwo" id="phonenumbertwo" class="form-control" />
                                    </div>
                                    @endif

                                    @if(in_array('address', $form_check))
                                    <div class="col-sm-12 form-group">
...
<div class="col-sm-12 form-group">
                                        <label>Your Active Email Address (Optional, Receipt for your order will be sent here):</label>
                                    ...
                                    <div class="col-sm-12 form-group">
                                        <label><b style="color: #8b0000;">Select The One You Want To Order:</label>
                                    <br><br>
                                      @foreach(json_decode($form->products) as $products)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="" style="margin-left: 15px;">
                                                <input name="product" class="product" id="product" type="checkbox" value="{{ $product->id }}">
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <input id="total_{{ $product->id }}" style="max-width: 400px; display: inline-block;" class="form-control total" readonly value="₦{{ number_format($product->price) }}">
                                            </div>
                                 ...
                                 <div class="col-sm-12 form-group">
                                        <label><b style="color: #8b0000;">Select When You Want The Delivery:</label>
                                        <br><br>
                                      @php
                                      $dtimes = json_decode($form->delivery_times);
                                      @endphp
                                      @if(count($dtimes) > 0)
	                                    	@foreach($dtimes as $time)
	                                      	@php $d = App\DeliveryTimes::find($time); @endphp
                                            @if($d)
										  	@if($d->hide == 0)
    	                                        <div class="row">

    	                                            <div class="radio" style="margin-left: 15px;">
    	                                                <input type="checkbox" class="product delivery_time" name="delivery_time" value="{{ $d->id }}">
    	                                            </div>

    	                                            <div class="col-sm-12">
    	                                                <input class="form-control" readonly value="{{ $d->value }}">
    	                                            </div>
        ...
        $('#submitBtn').click(function(e) {
            ...
            .then(function (response) {
                ...
                if(data.code == 400) {
                    ...
                    Swal.fire({
                          title: '<strong>Your Order Has Been Placed Successfully!</strong>',
                          type: 'success',
                          html:
                            data.message,
                          showCloseButton: true,
