...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <title>OrderBank | Modern OrderForm for businesses to take orders - @yield('title')</title>
    <style>
...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="#"><img src="/ORDERBANK%20IDENT%20logo%20white.png?vc=2" style="width: 200px;"/></a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto navbar-right-top">
                    ...
                    @endif
                       {{-- <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/$business->business_logo ?? '/asset/images/white.png.png?vc=2" alt="" class="user-avatar-md rounded-circle"></a>
...
<footer class="footer fixed-bottom d-block d-md-none" style="
    background: #6049ed;
    color: #fff;
">
    <div class="col-xs-12 navbar-inverse navbar-fixed-bottom" style="padding: 5px;text-align: center;color: #fff;">
        <div class="row" id="">
          <div class="col text-center"><a href="/reports" style="color: #fff; font-size: 15px;"><i class="fa fa-home"></i><br>Home</a></div>
          <div class="col text-center"><a href="/orders?filter=new" style="color: #fff; font-size: 15px;"><i class="fa fa-book"></i><br>New</a></div>
          <div class="col text-center"><a href="/orders/new" style="color: #fff; font-size: 15px;"><i class="fa fa-plus-square-o"></i><br>+Input</a></div>
          <div class="col text-center"><a href="/orders?filter=delivered" style="color: #fff; font-size: 15px;"><i class="fa fa-envelope"></i><br>Delivered</a></div>
          {{-- <div class="col text-center"><a href="#" onclick="alert('Coming soon...')" style="color: #fff; font-size: 15px;"><i class="fa fa-file"></i><br>Funnel</a></div>
          <div class="col text-center"><a href="#" style="color: #fff; font-size: 15px;"><i class="fa fa-link"></i><br>More</a></div> --}}
        </div>
        </div>
</footer>
