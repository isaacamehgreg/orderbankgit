@extends('app')
@section('title', 'Waybill - Payments - Edit')
@section('content')
...
<div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Edit Payment <a href="/payments" style="color: #fff;" class="btn btn-sm btn-success float-right"><b>Go back</b></a></h5>
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="col-sm-6 form-group">
                                        <label>Amount</label>
                                        <input name="amount" value="{{ $payments->amount }}" class="form-control" />
                                    </div>
